<template>
    <div class="me">
        ...
        <div class="content">
            <div class="user-info">
                <div class="info">
                <img src="../../assets/pig-foot-rice.jpg" />
                <div class="user-desc">
                    <span>昵称：{{ name }}</span>
...
// 序列化 localStorage.setItem("userInfo", JSON.stringify(newUserInfo))
                name: JSON.parse(localStorage.getItem('userInfo')).user,
                describe: store.state.userData.sign || '我即是天选，也是唯一'
            })
            const go = (path) => {
                router.push(path)
            }
